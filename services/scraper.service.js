...
export class ScraperService {
    ...
    try {
      ...
      for (let attempt = 1; attempt <= 2; attempt++) {
        try {
          ...
          // Only scrape page 1
          const url = config.scraper.baseUrl.replace('{}', '1');
          ...
          const urls = await this.browserService.extractJobUrls();
  ...
  async start() {
    ...
    await this.scrapeUpworkJobUrls();
